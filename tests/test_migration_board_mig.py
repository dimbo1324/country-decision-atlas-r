"""Schema assertions for the Migration Board Companions migration, including its privacy-lifecycle constraints."""

from pathlib import Path


MIGRATION_SQL = Path("database/migrations/045_migration_board.sql").read_text(
    encoding="utf-8"
)
