"""Schema assertions for the content localization foundation migration and source hashing."""
...
MIGRATION_SQL = Path("database/migrations/011_localization.sql").read_text(
    encoding="utf-8"
)
