"""Schema assertions for the decision-personalization migration and its seeded feature flags."""

from pathlib import Path


MIGRATION = Path("database/migrations/036_decision_personalization.sql")
