...
from utils.synthetic_data.core.cii_preview import (  # noqa: E402
    generate_cii_preview,
)
from utils.synthetic_data.core.dataset_diff import (  # noqa: E402
    diff_worlds,
)
from utils.synthetic_data.core.dataset_discovery import (  # noqa: E402
    available_dataset_ids,
    find_dataset_dir,
    list_datasets,
)
from utils.synthetic_data.core.dataset_prune import (  # noqa: E402
    apply_prune,
    plan_prune,
)
...
from utils.synthetic_data.core.locale_corpus import (  # noqa: E402
    LocaleCorpusError,
    load_locale_corpus,
)
from utils.synthetic_data.core.models import FileFormat  # noqa: E402
from utils.synthetic_data.core.output_layout import (  # noqa: E402
    resolve_output_dir,
)
from utils.synthetic_data.core.paths import (  # noqa: E402
    DEFAULT_INPUT_DATA_FILE,
    DEFAULT_OUTPUT_DATA_ROOT,
    DEFAULT_WORLD_INPUT_FILE,
)
from utils.synthetic_data.core.random_content import (  # noqa: E402
    RandomContentFactory,
)
from utils.synthetic_data.core.sql_loader import (  # noqa: E402
    SqlLoaderError,
    ensure_not_production,
    execute_sql_file,
)
from utils.synthetic_data.core.translation_adapter import (  # noqa: E402
    TranslationAdapterError,
    generate_translation_preview,
)
from utils.synthetic_data.core.world_generator import (  # noqa: E402
    SCALE_PROFILES,
    WorldGenerationOptions,
    WorldGenerator,
)
from utils.synthetic_data.core.world_input import (  # noqa: E402
    WorldInputError,
    load_world_input,
)
from utils.synthetic_data.core.world_models import (  # noqa: E402
    SyntheticWorld,
)
from utils.synthetic_data.core.world_validation import (  # noqa: E402
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "utils/synthetic_data/input_data/data.json)."
        ),
    )
    parser.add_argument(
        "--output-root",
        ...
        help=("Root directory for generated files (default: .synthetic_data)."),
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
...
def build_world_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="World JSON configuration (default: utils/synthetic_data/input_data/world_config.json).",
    )
    parser.add_argument(
        "--profile",
        default="balanced",
...
def _run_legacy(argv: list[str]) -> int:
    from utils.synthetic_data.core.registry import get_generator
