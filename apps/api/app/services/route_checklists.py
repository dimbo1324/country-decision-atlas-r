...
from app.schemas.route_checklists import RouteChecklistItem, RouteChecklistResponse
...
def get_route_checklist(
    ...
    return RouteChecklistResponse(items=[RouteChecklistItem(**row) for row in rows])
